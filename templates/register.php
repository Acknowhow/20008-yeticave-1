<?= $nav ?>
<form class="form container <? if (!empty($errors)) : ?>form_invalid<? endif; ?>" action="/register.php" method="POST"
    ...
    <div class="form__item <? if (!empty($errors['user_password'])) : ?>form__item--invalid<? endif; ?>">
    ...
    <div class="form__item <? if (!empty($errors['user_name'])) : ?>form__item--invalid<? endif; ?>">
        ...
        <span class="form__error"><? if (isset($errors['user_name'])) : ?><?= $errors['user_name']; ?><? endif; ?></span>
    </div>
    <div class="form__item <? if (!empty($errors['user_contacts'])) : ?>form__item--invalid<? endif; ?>">
        ...
        <span class="form__error"><? if (isset($errors['user_contacts'])) : ?><?= $errors['user_contacts']; ?><? endif; ?></span>
    </div>
    <div class="form__item form__item--file form__item--last">
        ...
        <div class="preview">
            ...
            <div class="preview__img">
                <img src="" width="113" height="113" alt="<?= $user_img['user_img_alt']; ?>">
            </div>
        </div>
        <div class="form__input-file">
            ...
            <span
                class="form_error"><? if (isset($errors['user_img'])) : ?><?= $errors['user_img']; ?><? endif; ?></span>
        </div>
    </div>
